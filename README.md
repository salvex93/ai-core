# AI-CORE v3.36.0: Nucleo Multi-Agente
...
npm test                                  # 1305 tests, Node nativo, sin deps externas
...
├── tests/                       1305 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.36.0, Node >= 22.13.0
