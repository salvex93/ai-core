# AI-CORE v3.35.1: Nucleo Multi-Agente
...
npm test                                  # 1294 tests, Node nativo, sin deps externas
...
├── tests/                       1294 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.35.1, Node >= 22.13.0
