# AI-CORE v3.35.0: Nucleo Multi-Agente
...
npm test                                  # 1292 tests, Node nativo, sin deps externas
...
├── tests/                       1292 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.35.0, Node >= 22.13.0
