# AI-CORE v3.36.1: Nucleo Multi-Agente
...
npm test                                  # 1306 tests, Node nativo, sin deps externas
...
├── tests/                       1306 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.36.1, Node >= 22.13.0
