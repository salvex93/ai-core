# AI-CORE v3.36.2: Nucleo Multi-Agente
...
npm test                                  # 1308 tests, Node nativo, sin deps externas
...
├── tests/                       1308 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.36.2, Node >= 22.13.0
