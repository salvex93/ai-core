# AI-CORE v3.35.2: Nucleo Multi-Agente
...
npm test                                  # 1296 tests, Node nativo, sin deps externas
...
├── tests/                       1296 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
...
├── package.json                 v3.35.2, Node >= 22.13.0
