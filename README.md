...
npm test                                  # 1414 tests (1413 pass, 1 skip), Node nativo, sin deps externas
...
├── tests/                       1414 tests — tests/harness/*.test.js (dividido por modulo) + archivos dedicados
