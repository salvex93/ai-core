...
| G10 | 6 dominios cerca del umbral de vigencia (mcp-protocol a 55 dias; cinco dominios de 2026-08-04 a 48 dias) | `audit-market` | PARCIAL 2026-09-21: `mcp-protocol` y `ai-core-internal-governance` reverificados. Pendientes con fecha limite 2026-10-03: `app-distribution-stores`, `saas-business-architecture`, `qa-destructive-testing`, `cloud-provider-deployment` (requieren fuente primaria externa) |
